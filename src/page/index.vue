...
<div>
    ...
    <mu-popup position="bottom" popupClass="Login-popup-bottom" :open="LoginBottom" @close="LoginBottomClose">
        <mu-content-block class="Login-Bottom">
            ...
            <div class="Login-Bottom-Icon">
                <img src="http://ovadapy3v.bkt.clouddn.com/fw.png">
            </div>
            <mu-sub-header style="color:#ff5252">先登录才可以进行下一步操作哦！</mu-sub-header>
            <mu-sub-header>11位数字登录测试功能，12位数字进入注册页！</mu-sub-header>
    ...
    <mu-bottom-nav :value="bottomNav" @change="handleChange">
        ...
        <mu-bottom-nav-item value="exhibition" title="图册" icon="collections" to="/exhibition" />
