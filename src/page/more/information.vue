...
<div>
    ...
    <mu-card v-for="(item,index) in information_datas" :key="item.id">
            <mu-list-item v-if="item.name != '蒋吉兆'" class="Top-list-item" :title="item.name + ' | ' + '#' + item.type" :describeText="item.date">
            ...
            <mu-list-item v-else class="Top-list-item" :title="'我' + ' | ' + '#' + item.type" :describeText="item.date">
                <mu-avatar src="http://ovadapy3v.bkt.clouddn.com/hexo/imglufei.jpg" slot="leftAvatar"/>
